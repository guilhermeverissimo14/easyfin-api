				...
				properties: {
					...
					bankAccount: {
						...
						properties: {
							...
							agency: {
								type: "string",
								description: "Agência bancária (opcional)",
							},
							account: {
								type: "string",
								description: "Número da conta bancária (opcional)",
							},
						},
	...
	response: {
		200: {
			...
			properties: {
				...
				userId: {
					type: "string",
					description: "ID do usuário associado à fatura (opcional)",
				},
			},
		},
		400: {
...
export const deleteInvoiceSchema = {
	...
	description:
		"Exclui uma fatura e suas contas a receber relacionadas. A fatura só pode ser excluída se não tiver sido liquidada (integral ou parcialmente).",
	params: {
		type: "object",
		properties: {
			id: {
	...
	response: {
		200: {
			...
			type: "object",
			properties: {
				message: { type: "string", example: "Fatura excluída com sucesso" },
			},
		},
		400: {
			description: "Erro de validação ou fatura com pagamentos",
			type: "object",
			properties: {
				message: { type: "string" },
			},
