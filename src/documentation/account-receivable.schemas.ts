		...
		200: {
			...
			properties: {
				...
				receivedThisMonth: {
					type: "number",
					description:
						"Total de contas a receber em atraso este mês (Vencido este mês)",
				},
				receivedThisWeek: {
					type: "number",
					description:
						"Total de contas a receber em atraso esta semana (Vencido esta semana)",
				},
				receivedToday: {
					type: "number",
					description:
						"Total de contas a receber em atraso hoje (Vencido hoje)",
				},
			},
			example: {
				totalReceivable: 5000.0,
				totalDueReceivable: 1500.0,
			...
			items: {
				...
				properties: {
					...
					installmentNumber: {
						type: "number",
						description:
							"Número da parcela (opcional, padrão é 1 se não for parcelado)",
					},
					totalInstallments: {
						type: "number",
						description:
							"Total de parcelas (opcional, padrão é 1 se não for parcelado)",
					},
					costCenter: {
						type: "object",
						properties: {
							...
							name: {
								type: "string",
								description: "Nome do centro de custo (opcional)",
							},
						},
					},
					plannedPaymentMethod: {
						...
						properties: {
							id: {
								type: "string",
								description: "ID do método de pagamento planejado (opcional)",
							},
							name: {
								type: "string",
								description: "Nome do método de pagamento planejado (opcional)",
							},
						},
					},
					paymentMethod: {
			...
			properties: {
				...
				user: {
					...
					properties: {
						...
						name: {
							type: "string",
							description: "Nome do usuário que criou a conta",
						},
					},
				},
