      ...
      200: {
         ...
         items: {
            ...
            properties: {
               ...
               totalInstallments: {
                  type: 'number',
                  description: 'Total de parcelas (opcional, padrão é 1 se não for parcelado)',
               },
               costCenter: {
                  type: 'object',
                  properties: {
               ...
               hasInvoiceLink: {
                  type: 'boolean',
                  description: 'Indica se a conta está vinculada a um documento (opcional, padrão: false)',
               },
               hasCashFlow: {
                  type: 'boolean',
